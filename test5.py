...
def detect_health():
    ...
    while True:
        ...
        # Keep HSV for detection logic
        hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
        # Create Grayscale version for viewing
        ...
        # Display both the processed color frame and the grayscale version
        cv2.imshow("AgriScan AI - WiFi Edition", frame)
        cv2.imshow("AgriScan AI - Grayscale View", gray_frame)
